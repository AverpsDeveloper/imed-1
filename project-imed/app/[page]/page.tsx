    ...
    <div className="flex justify-between px-4 mx-auto max-w-screen-xl ">
      <article className="mx-auto w-full max-w-4xl format format-sm sm:format-base lg:format-lg format-blue dark:format-invert">
        <header className="mb-4 lg:mb-6 not-format">
          <h1 className="mb-4 text-3xl font-extrabold leading-tight text-gray-900 lg:mb-6 lg:text-4xl dark:text-white">About Us</h1>
        </header>
        <p className="lead">Imed is an open-source library of UI components built with the utility-first
        ...
        <p>First of all you need to understand how Imed works. This library is not another framework.
        ...
        <p>You can check out the <a href="https://flowbite.com/docs/getting-started/quickstart/">quickstart
          ...
          to build a project with Imed I recommend you to follow the build tools steps so that you can
        ...
        <blockquote>
          <p>Imed is just awesome. It contains tons of predesigned components and pages starting from
        ...
        <p><strong>Start from the inside out</strong>. A nice way to both organize your tasks and create more
          ...
          of your design.</p>
        <p>And there you have it! Everything you need to design and share prototypes — right in Imed Figma.
        </p>
      </article>
    </div>
  </main>
