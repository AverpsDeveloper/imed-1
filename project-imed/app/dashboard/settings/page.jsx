...
const validationSchemaInfo = Yup.object().shape({
  ...
  adminEmail: Yup.string().email().required('Admmin email is required.'),
  supportEmail: Yup.string().email().required('Support email is required.'),
});

const smtpSetup = Yup.object().shape({
  email: Yup.string().email().required('Email is required for SMTP Setup.'),
...
const SettingPages = () => {
  ...
  const [initialValuesForSMTP, setinitialValuesForSMTP] = useState({
