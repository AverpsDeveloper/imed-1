            ...
            <div className="flex justify-between mb-4 ">
                ...
                <div className="flex items-center space-x-2">
                    ...
                    <button
                        ...
                        className={`px-4 py-2 rounded ${genderFilter === 'all' ? 'bg-blue-500 text-white' : 'bg-gray-200'}`}> All </button>
                    <button onClick={() => setGenderFilter("male")} className={`px-4 py-2 rounded ${genderFilter === 'male' ? 'bg-blue-500 text-white' : 'bg-gray-200'}`}> Male </button>
                    <button onClick={() => setGenderFilter("female")} className={`px-4 py-2 rounded ${genderFilter === 'female' ? 'bg-blue-500 text-white' : 'bg-gray-200'}`}> Female </button>
                </div>
            </div>
