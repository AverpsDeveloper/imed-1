            ...
            <form onSubmit={handleSubmit(onSubmit)}>
              <div className="p-6.5">
                <div className="mb-4.5 flex flex-col gap-6 xl:flex-row">
                  <div className="w-full xl:w-1/2">
                    <label className="mb-2.5 block text-black dark:text-white">
                      Medicine Name<span className="text-meta-1">*</span>
                    </label>
                    <input
                      type="text"
                ...
                <div className="mb-4.5 flex flex-col gap-6 xl:flex-row">
                  <div className="w-full xl:w-1/2">
                    <label className="mb-2.5 block text-black dark:text-white">
                      Strength <span className="text-meta-1">*</span>
                    </label>
                    <input
                      type="text"
                      placeholder="Enter Page Name"
                  ...
                  <div className="w-full xl:w-1/2">
                    ...
                    <input
                      ...
                      {...register("seoSlug", { required: true })}
                      className="w-full rounded border-[1.5px] border-stroke bg-transparent py-3 px-5 font-medium outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary"
                    />
                    {errors.seoSlug && (
                      <span className="mb-2.5 block text-errors  dark:text-white">
                ...
                <div className="mb-4.5 flex flex-col gap-6 xl:flex-row">
                  ...
                  <div className="w-full xl:w-1/2">
                    <label className="mb-2.5 block text-black dark:text-white">
                      unitof Measure<span className="text-meta-1">*</span>
                    </label>
                    <input
                      type="text"
                      placeholder="Enter SEO Slug"
                ...
                <div className="mb-4.5 flex flex-col gap-6 xl:flex-row">
                  <div className="w-full xl:w-1/2">
                    <label className="mb-2.5 block text-black dark:text-white">
                      Medicine Category<span className="text-meta-1">*</span>
                    </label>
                    <div className="relative z-20 bg-transparent dark:bg-form-input">
                      <select
                        {...register("published", { required: true })}
                  ...
                  <div className="w-full xl:w-1/2">
                    <label className="mb-2.5 block text-black dark:text-white">
                      batches <span className="text-meta-1">*</span>
                    </label>
                    <div className="relative z-20 bg-transparent dark:bg-form-input">
                      <input
                        type="text"
                ...
                <div className="mb-4.5 flex flex-col gap-6 xl:flex-row">
                  ...
                  <div className="w-full xl:w-1/2">
                    <label className="mb-2.5 block text-black dark:text-white">
                    PresetQuantity <span className="text-meta-1">*</span>
                    </label>
                    <div className="relative z-20 bg-transparent dark:bg-form-input">
                      <select
                        {...register("published", { required: true })}
